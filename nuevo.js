...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Configurar la lógica para abrir el modal cuando una letra es clickeada
    letras.forEach(function (letra) {
        letra.addEventListener('click', function () {
            var mensaje = letra.getAttribute('data-mensaje'); // Obtener el mensaje de la letra
            document.getElementById('modalMessage').textContent = mensaje; // Asignar el mensaje al modal

            // Abrir el modal con Bootstrap 5 (sin jQuery)
